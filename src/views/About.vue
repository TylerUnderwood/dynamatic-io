...
<template>
    ...
    <Section>
        <div class="bg-primary p-20 px-8 md:px-20" data-theme=dark>
            <span class="Heading">Theme Dark</span>
            <code class="Code mt-2" style="font-size: 0.8rem">[data-theme=dark] .bg-primary</code>
            <p class="Copy mt-2">This container will all ways be dark.</p>
            <ul class="List List--bullet List--colorFace mt-4">
                <li class="List__item" v-for="item in 4">Item {{ item }}</li>
            </ul>
            <div class="bg-base mt-6 p-20 px-8 md:px-20" data-theme=body>
                <span class="Heading">Theme Body</span>
                <code class="Code mt-2" style="font-size: 0.8rem">[data-theme=body] .bg-base</code>
